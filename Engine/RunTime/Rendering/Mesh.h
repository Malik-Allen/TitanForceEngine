...
struct Vertex {
	...
	static std::array<VkVertexInputAttributeDescription, TOTAL> GetAttributeDescriptions() {
		std::array<VkVertexInputAttributeDescription, TOTAL> attributesDesctiption = {};
